// Opt-in integration test: enabling it requires explicit authorization to inspect and replace the current general clipboard. Default tests use mocked subprocesses.
