...
Переход приостановлен по уточнению Владимира: сначала сравнить пользу,
стоимость и ограничения вариантов. Найденный ниже интерфейс — проверенный
кандидат для сравнения, а не принятое требование полной совместимости.
Черновики JavaScript facade/REPL не подключены к продукту.

## Исследуемый интерфейс

При полном переходе внешний API ai-macos повторял бы JavaScript-интерфейс
...
Это описание проверяемого варианта. Наличие этого документа не означает, что
